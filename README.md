...
```sh
  git clone https://github.com/musangamfure/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/musangamfure/hello-rails-react/issues/).
...
This project is [MIT](https://github.com/musangamfure/hello-rails-react/blob/dev/LICENSE) licensed.
